...
public class EmkYsPayServiceImpl extends CommonServiceImpl implements EmkYsPayServiceI {
	...
	private void doDelBus(EmkYsPayEntity t) throws Exception{
 	...
 	private Map<String,Object> populationMap(EmkYsPayEntity t){
		...
		map.put("kd_name", t.getKdName());
		map.put("bz", t.getBz());
		map.put("sum_money", t.getSumMoney());
		map.put("skdw_name", t.getSkdwName());
	 ...
	 */
 	public String replaceVal(String sql,EmkYsPayEntity t){
 		...
 		sql  = sql.replace("#{kd_name}",String.valueOf(t.getKdName()));
 		sql  = sql.replace("#{bz}",String.valueOf(t.getBz()));
 		sql  = sql.replace("#{sum_money}",String.valueOf(t.getSumMoney()));
 		sql  = sql.replace("#{skdw_name}",String.valueOf(t.getSkdwName()));
