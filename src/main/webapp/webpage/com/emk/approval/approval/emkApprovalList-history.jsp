...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="emkApprovalList" checkbox="false" pagination="true" fitColumns="true" pageSize="15" title="历史审批业务表" actionUrl="emkApprovalController.do?listAllByJdbc" idField="id" fit="true" btnCls="bootstrap"  queryMode="group">
   ...
   <t:dgCol title="创建人登录名称"  field="createBy"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
      ...
      <t:dgCol title="工单类型"  field="type" replace="订单_0" queryMode="single"  width="150"></t:dgCol>
