...
<table style="width:100%;display: none;border: 1px;" cellpadding="0" cellspacing="2" border="0">
    ...
    <tr>
        ...
        <td align="center"><input id="proZnName00" nullmsg="请输入原料面料名称！"  errormsg="请输入原料面料名称"  name="orderMxList[#index#].proZnName" maxlength="100" type="text" 
                                  style="width: 86%;" ignore="ignore"></td>
        <td align="center"><input id="proNum00" nullmsg="请输入原料面料代码！"  errormsg="请输入原料面料代码" name="orderMxList[#index#].proNum" maxlength="100" type="text" 
                                  style="width: 86%;" ignore="ignore"></td>
        <td align="center">
        ...
        <td align="center"><input id="brand00" nullmsg="请输入规格！"   errormsg="请输入规格" name="orderMxList[#index#].brand" maxlength="100" type="text" 
                                  style="width: 86%;" ignore="ignore"></td>
        <td align="center"><input id="precent00" nullmsg="请输入比例(%)！"  errormsg="请输入数值型" datatype="d" name="orderMxList[#index#].precent" maxlength="100" type="text" 
                                  style="width: 86%;" ></td>
        <td align="center"><input id="yongliang00" nullmsg="请输入单件用量！" onkeyup="if(isNaN(value))execCommand('undo')" onafterpaste="if(isNaN(value))execCommand('undo')"   errormsg="请输入单件用量" name="orderMxList[#index#].yongliang" maxlength="100" type="text"
                                  style="width: 86%;" ignore="ignore"></td>
        <td align="center"><input id="signTotal00" nullmsg="请输入件数！" datatype="n" onkeyup="this.value=this.value.replace(/\D/g,'')"  onafterpaste="this.value=this.value.replace(/\D/g,'')"  errormsg="请输入数值型" name="orderMxList[#index#].signTotal" maxlength="100" type="text" value=""
                                  style="width: 86%;" ignore="ignore"></td>
        <td align="center"><input id="signPrice00" nullmsg="请输入价格！" datatype="d" errormsg="请输入价格"  onafterpaste="if(isNaN(value))execCommand('undo')" name="orderMxList[#index#].signPrice" maxlength="100" type="text"
                                  style="width: 86%;" ignore="ignore"></td>
        <td align="center"><input id="unit00" nullmsg="请输入单位！" errormsg="请输入单位" name="orderMxList[#index#].unit" maxlength="100" type="text" 
                                  style="width: 86%;" ignore="ignore"></td>
        <td align="center"><input id="sunhaoPrecent00" nullmsg="请输入损耗率！" datatype="d"  errormsg="请输入损耗率" onafterpaste="if(isNaN(value))execCommand('undo')" name="orderMxList[#index#].sunhaoPrecent" maxlength="100" type="text"
                                  style="width: 86%;" ignore="ignore"></td>
        <%--<td align="center"><input id="sumYongliang00" nullmsg="请输入总用量！"   errormsg="请输入总用量" name="orderMxList[#index#].sumYongliang" maxlength="100" type="text" --%>
                                  <%--style="width: 86%;" ignore="ignore"></td>--%>
        <td align="center"><input id="chengben00" nullmsg="请输入成本！" datatype="d"  errormsg="请输入成本" name="orderMxList[#index#].chengben" maxlength="100" type="text" 
                                  style="width: 86%;" ignore="ignore"></td>
        <td align="center"><input id="position00" nullmsg="请输入位置！"   errormsg="请输入位置" name="orderMxList[#index#].position" maxlength="100" type="text" 
                                  style="width: 86%;" ignore="ignore"></td>
        <td align="center"><input id="rkState00" nullmsg="请输入入库状态！"   errormsg="请输入总用量" name="orderMxList[#index#].rkState" maxlength="100" type="text" 
                                  style="width: 86%;" ignore="ignore"></td>
    </tr>
    </tbody>
            ...
            <c:if test="${fn:length(emkSampleDetailEntities)  > 0 }">
                ...
                <c:forEach items="${emkSampleDetailEntities}" var="poVal" varStatus="status">
                    ...
                    <tr>
                        ...
                        <td align="center"><input  nullmsg="请输入规格！"  errormsg="请输入规格" id="brand${status.index}" value="${poVal.brand}" name="orderMxList[${status.index}].brand" maxlength="100" type="text" 
                                                   style="width: 86%;" ignore="ignore"></td>
                        <td align="center"><input  nullmsg="请输入比例(%)！" id="precent${status.index}"  errormsg="请输入数值型" value="${poVal.precent}" name="orderMxList[${status.index}].precent" maxlength="100" type="text"
                                                   style="width: 86%;" ignore="ignore"></td>
                        <td align="center"><input  nullmsg="请输入单件用量！"  errormsg="请输入单件用量" id="yongliang${status.index}"  onkeyup="if(isNaN(value))execCommand('undo')" onafterpaste="if(isNaN(value))execCommand('undo')" value="${poVal.yongliang}" name="orderMxList[${status.index}].yongliang" maxlength="100" type="text"
                                                  style="width: 86%;" ignore="ignore"></td>
                        <td align="center"><input  nullmsg="请输入件数！" id="signTotal${status.index}" onkeyup="this.value=this.value.replace(/\D/g,'')"  onafterpaste="this.value=this.value.replace(/\D/g,'')" datatype="n" errormsg="请输入数值型" value="${poVal.signTotal}" name="orderMxList[${status.index}].signTotal" maxlength="100" type="text"
                                                   style="width: 86%;" ignore="ignore"></td>
                        <td align="center"><input  nullmsg="请输入价格！" id="signPrice${status.index}"  onkeyup="if(isNaN(value))execCommand('undo');setPrice(${status.index})" onafterpaste="if(isNaN(value))execCommand('undo')"  errormsg="请输入价格" datatype="d"  value="${poVal.signPrice}" name="orderMxList[${status.index}].signPrice" maxlength="100" type="text"
                                                  style="width: 86%;" ignore="ignore"></td>
                        <td align="center"><input  nullmsg="请输入单位！" id="unit${status.index}"   errormsg="请输入单位" value="${poVal.unit}" name="orderMxList[${status.index}].unit" maxlength="100" type="text"
                                                   style="width: 86%;" ignore="ignore"></td>
                        <td align="center"><input  nullmsg="请输入损耗率！"  id="sunhaoPrecent${status.index}" onkeyup="if(isNaN(value))execCommand('undo');setPrice(${status.index})" onafterpaste="if(isNaN(value))execCommand('undo')"  errormsg="请输入损耗率" datatype="d" value="${poVal.sunhaoPrecent}" name="orderMxList[${status.index}].sunhaoPrecent" maxlength="100" type="text"
                                                  style="width: 86%;" ignore="ignore"></td>
                        <%--<td align="center"><input  nullmsg="请输入总用量！"  errormsg="请输入总用量" value="${poVal.sumYongliang}" name="orderMxList[${status.index}].sumYongliang" maxlength="100" type="text"
                                                   style="width: 86%;" ignore="ignore"></td>--%>
                        <td align="center"><input  nullmsg="请输入成本(含损耗)！" id="chengben${status.index}"  errormsg="请输入成本(含损耗)" datatype="d" value="${poVal.chengben}" name="orderMxList[${status.index}].chengben" maxlength="100" type="text" 
                                                  style="width: 86%;" ignore="ignore"></td>
                        <td align="center"><input  nullmsg="请输入位置！"  errormsg="请输入位置" value="${poVal.position}" name="orderMxList[${status.index}].position" maxlength="100" type="text" 
                                                   style="width: 86%;" ignore="ignore"></td>
                        <td align="center"><input  nullmsg="请输入入库状态！"  errormsg="请输入入库状态" value="${poVal.rkState}" name="orderMxList[${status.index}].rkState" maxlength="100" type="text" 
                                                   style="width: 86%;" ignore="ignore"></td>
                    </tr>
