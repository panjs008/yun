...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="emkProOrderBarcodeController.do?doAdd" tiptype="1">
	  ...
	  <table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
			  <tr>
				  ...
				  <td class="value">
					  <t:dictSelect id="type" field="type" typeGroupCode="barcode" datatype="*" defaultVal="default" hasLabel="false" title="条码类型"></t:dictSelect>
