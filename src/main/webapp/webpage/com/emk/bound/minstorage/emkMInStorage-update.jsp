...
<head>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			$("#detail").load("emkMInStorageController.do?orderMxList&type=${param.type}&inStorageId=${emkMInStoragePage.id}");
		});
...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="emkMInStorageController.do?doUpdate" tiptype="1">
	...
	<table style="width: 100%;margin-top:22px;" cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
				<input id="businesserDate" name="businesserDate" readonly value="${emkMInStoragePage.businesserDate eq null ? kdDate: emkMInStoragePage.businesserDate}" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})"  type="text" style="width: 150px" class="Wdate"  ignore="ignore" />
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
				<input id="tracerDate" name="tracerDate" readonly value="${emkMInStoragePage.tracerDate eq null ? kdDate: emkMInStoragePage.tracerDate}" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})"  type="text" style="width: 150px" class="Wdate"  ignore="ignore" />
				<span class="Validform_checktip"></span>
				<label class="Validform_label" style="display: none;">日期</label>
			</td>
		</tr>
		...
		<tr>
			...
			<td class="value">
				<input id="caigouerDate" name="caigouerDate" readonly value="${emkMInStoragePage.caigouerDate eq null ? kdDate: emkMInStoragePage.caigouerDate}" onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})"  type="text" style="width: 150px" class="Wdate"  ignore="ignore" />
				<span class="Validform_checktip"></span>
				<label class="Validform_label" style="display: none;">日期</label>
			</td>
		</tr>
