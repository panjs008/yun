...
<head>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			$("#detail").load("emkMInStorageController.do?orderMxList&type=${emkMInStoragePage.type}&inStorageId=${emkMInStoragePage.id}");
		});
...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="emkMInStorageController.do?doUpdate" tiptype="1">
	...
	<table style="width: 100%;margin-top:8px;" cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			<td align="right" >
				<label class="Validform_label">
					业务员:
