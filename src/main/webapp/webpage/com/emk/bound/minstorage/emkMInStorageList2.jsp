...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="emkMInStorageList" checkbox="false" pagination="true" fitColumns="true" sortOrder="desc" sortName="kdDate"  title="" actionUrl="emkMInStorageController.do?datagrid&type=1" idField="id" fit="true" btnCls="bootstrap"  queryMode="group">
 ...
 function doPrintPDF() {
     ...
     if (!rowsData || rowsData.length == 0) {
         tip('请选择需要导出PDF的缝制辅料入库申请单');
         return;
     }
     for ( var i = 0; i < rowsData.length; i++) {
         ids.push(rowsData[i].id);
     }
     $.dialog.confirm('您是否确定导出PDF的缝制辅料入库申请单?', function(r) {
         if (r) {
