...
<script type="text/javascript">
    ...
    $('#addBtn2').bind('click', function(){
        ...
        $("#add_jeecgOrderProduct_table2").find("[id='color00']").attr("id","color"+flag);
...
<table style="width:100%;display: none;border: 1px;" cellpadding="0" cellspacing="2" border="0">
    ...
    <tr>
        ...
        <td align="center"><input id="bwidth00" nullmsg="请输入幅宽！"  errormsg="请输入幅宽" name="orderMxList[#index#].bwidth" maxlength="100" type="text" value=""
                                  style="width: 86%;" ignore="ignore"></td>
        <td align="center">
            <%--<input id="bcolor00" nullmsg="请输入颜色！"  errormsg="请输入颜色" name="orderMxList[#index#].bcolor" maxlength="100" type="text" value=""
                                  style="width: 86%;" ignore="ignore">--%>
            <select id="color00" name="orderMxList[#index#].bcolor" class="form-control select2" style="width:100px;">
        ...
        <td align="center"><input id="bchengf00" nullmsg="请输入成分！"  errormsg="请输入成分" name="orderMxList[#index#].bchengf" maxlength="100" type="text" value=""
                                  style="width: 86%;" ignore="ignore"></td>
        <td align="center"><input id="bsignTotal00" datatype="n"  nullmsg="请输入数量！"  errormsg="请输入整数" name="orderMxList[#index#].bsignTotal" maxlength="100" type="text" value=""
                                  style="width: 86%;" ignore="ignore"></td>
...
<div class="table-c">
    <table id="mxtb2" width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr bgcolor="#F8F8F8" style="height: 32px;" >
            ...
            <td align="center"  width="100">单件用量</td>
            ...
            <td align="center"  width="100">损耗率</td>
            <td align="center"  width="100">备注</td>
            <td align="center"  width="130">供应商</td>
            ...
            <c:forEach items="${emkSampleDetailEntities}" var="poVal" varStatus="status">
                ...
                <tr>
                    ...
                    <td align="center"><input  nullmsg="请输入幅宽！"  errormsg="请输入幅宽" value="${poVal.width}" name="orderMxList[${status.index}].bwidth" maxlength="100" type="text" value=""
                                               style="width: 86%;" ignore="ignore"></td>
                    <td align="center">
                        <%--<input  nullmsg="请输入颜色！"  errormsg="请输入颜色" value="${poVal.color}" name="orderMxList[${status.index}].bcolor" maxlength="100" type="text" value=""
                                               style="width: 86%;" ignore="ignore">--%>
                        <select id="color${status.index}" name="orderMxList[${status.index}].bcolor"  class="form-control select2" style="width:100px;">
                            <option value=''>请选择</option>
                        </select>
                        <script>
                    ...
                    <td align="center"><input  nullmsg="请输入成分！"  errormsg="请输入成分" value="${poVal.chengf}" name="orderMxList[${status.index}].bchengf" maxlength="100" type="text" value=""
                                               style="width: 86%;" ignore="ignore"></td>
                    <td align="center"><input  nullmsg="请输入数量！"  datatype="n"  errormsg="请输入整数" value="${poVal.signTotal}" name="orderMxList[${status.index}].bsignTotal" maxlength="100" type="text" value=""
                                               style="width: 86%;" ignore="ignore"></td>
        ...
        <tr>
            <td colspan="5"></td>
            <td align="center"><input  value="<fmt:formatNumber type="number" value="${zyl}" pattern="0.0" maxFractionDigits="2"/>"  type="text" style="width: 86%;" ignore="ignore"></td>
            <td colspan="6"></td>
