...
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="emkCancelOrderController.do?doUpdate" tiptype="1">
	...
	<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value" >
				<input type="text" id="orderNo" name="orderNo" readonly value="${emkCancelOrderPage.orderNo }" style="width: 150px" />
					<%--<select class="form-control select2" id="orderNo" value="${emkCancelOrderPage.orderNo }"  name="orderNo" datatype="*"  >
                        <option value=''>请选择</option>
                    </select>--%>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
				<input id="betch" name="betch" type="text" value="${emkCancelOrderPage.betch }"  style="width: 150px" class="inputxt" datatype="*"   value='${emkCancelOrderPage.betch}'/>
				<span class="Validform_checktip"></span>
