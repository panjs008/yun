	...
	<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value">
				...
				是
				&nbsp;&nbsp;<input name="isPeopleAdvice" type="radio" onclick="setReruire('peopleAdvice',1);" datatype="*"  <c:if test="${emkCustomUsePage.isPeopleAdvice eq '1'}">checked="true"</c:if> value="1">
				否
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
				<input name="isZlAdvice" type="radio" onclick="setReruire('zlAdvice',0);" datatype="*" <c:if test="${emkCustomUsePage.isZlAdvice eq '0'}">checked="true"</c:if> value="0">
				是
		...
		<tr>
			...
			<td class="value">
				<input name="isFkAdvice" type="radio" onclick="setReruire('fkAdvice',0);" datatype="*" <c:if test="${emkCustomUsePage.isFkAdvice eq '0'}">checked="true"</c:if> value="0">
				是
		...
		<tr>
			...
			<td class="value">
				<input name="isCheckHuo" type="radio" onclick="setReruire('checkHuo',0);" datatype="*" <c:if test="${emkCustomUsePage.isCheckHuo eq 0}">checked="true"</c:if> value="0">
				是
		...
		<tr>
			...
			<td class="value">
				<input name="isTest" type="radio" onclick="setReruire('test',0);" datatype="*" <c:if test="${emkCustomUsePage.isTest eq '0'}">checked="true"</c:if> value="0">
				是
		...
		<tr>
			...
			<td class="value">
				<input name="isPact" type="radio" onclick="setReruire('pact',0);" datatype="*" <c:if test="${emkCustomUsePage.isPact eq '0'}">checked="true"</c:if> value="0">
				是
		...
		<tr>
			...
			<td class="value">
				<input name="isSample" type="radio" onclick="setReruire('sample',0);" datatype="*" <c:if test="${emkCustomUsePage.isSample eq '0'}">checked="true"</c:if> value="0">
				是
		...
		<tr>
			...
			<td class="value">
				<input name="isSendHuo" type="radio" onclick="setReruire('sendHuo',0);" datatype="*" <c:if test="${emkCustomUsePage.isSendHuo eq '0'}">checked="true"</c:if> value="0">
				是
			...
			<td class="value" colspan="5">
				<table style="width:890px;" cellpadding="0" cellspacing="1" class="formtable">
					...
					<tr>
						...
						<td class="value">
							<input id="email" name="email" type="text" value="${ymkCustomPage.email }" datatype="e" style="width: 90px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
