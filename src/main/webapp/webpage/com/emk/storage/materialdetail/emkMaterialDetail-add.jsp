...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="emkMaterialDetailController.do?doAdd" tiptype="1">
					<input id="id" name="id" type="hidden" value="${emkMaterialDetailPage.id }"/>
	  <input id="materialId" name="materialId" type="hidden" value="${param.materialId }"/>
	  <table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
			<tr>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="signTotal" name="signTotal" type="text" style="width: 150px" class="inputxt"  datatype="n"  ignore="ignore" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="direction" name="direction" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	 <input id="betchNum" name="betchNum" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="width" name="width" type="text" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
