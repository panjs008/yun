...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="emkSampleYinController.do?doAdd" tiptype="1">
	  ...
	  <table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
						<t:dictSelect id="gyzy" field="gyzy" typeGroupCode="yhgyzl" datatype="*" defaultVal="${emkSampleYinPage.gyzl}" hasLabel="false" title="工艺类型"></t:dictSelect>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="chengben" name="chengben" type="text" style="width: 150px" class="inputxt"  datatype="/^(-?\d+)(\.\d+)?$/"  ignore="ignore" />
							<span class="Validform_checktip"></span>
